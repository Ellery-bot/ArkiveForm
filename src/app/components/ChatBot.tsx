    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="flex items-center justify-center gap-4 md:gap-8 max-w-6xl w-full">
        ...
        >
          {/* Avatar Circle */}
          <motion.div
            className="w-40 h-40 md:w-48 md:h-48 flex items-center justify-center relative z-20"
          ...
          <motion.a
            href="/"
            className="mt-8 inline-block px-6 py-3 bg-gray-800 text-white rounded-lg font-semibold hover:bg-gray-900 transition-colors text-sm md:text-base"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 1 }}
          >
