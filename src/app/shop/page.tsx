...
/* ─── Product Data ─── */
const PRE_ORDER: Product[] = [
  { id: 1, title: '[PRE ORDER] BTS - OFFICIAL LIGHTSTICK VER. 4', price: 'From ₱2,500.00', originalPrice: '₱3,799.00', hasOptions: true, badge: 'Sale' },
  { id: 2, title: '[PRE ORDER] BLACKPINK × TAMAGOTCHI', price: '₱4,500.00', hasOptions: false },
  { id: 3, title: '[PRE ORDER] JENNIE - RUBY [1st STUDIO ALBUM]', price: '₱1,600.00', hasOptions: false },
  { id: 4, title: '[PRE ORDER] BTS - 10 STAR (BTS 2000 DAYS JOURNEY)', price: '₱900.00', hasOptions: false },
  { id: 5, title: '[PRE ORDER] BTS WHAT IS YOUR LOVE SONG CARRIER STRAP', price: '₱830.00', hasOptions: false },
  { id: 6, title: '[PRE ORDER] BTS ARIRANG WORLD TOUR PICK UP MERCH', price: 'From ₱800.00', hasOptions: true },
]

const ON_HAND: Product[] = [
  { id: 7,  title: '[ON HAND] BLACKPINK JISOO FIRST SINGLE ALBUM', price: 'From ₱700.00', hasOptions: true },
  { id: 8,  title: '[ON HAND] BLACKPINK - DEADLINE [3rd Mini Album]', price: 'From ₱1,100.00', hasOptions: true },
  { id: 9,  title: '[ON HAND] BLACKPINK DEADLINE OFFICIAL MERCH', price: 'From ₱1,000.00', hasOptions: true },
  { id: 10, title: '[ON HAND] ENHYPEN ROMANCE : UNTOLD', price: 'From ₱759.00', originalPrice: '₱859.00', hasOptions: true, badge: 'Sale' },
  { id: 11, title: '[ON HAND] BTS OFFICIAL LIGHTSTICK v4 [ARMY BOMB]', price: 'From ₱930.00', hasOptions: true },
  { id: 12, title: '[ON HAND] G-DRAGON 3RD ALBUM UBERMENSCH', price: 'From ₱890.00', originalPrice: '₱1,000.00', hasOptions: true, badge: 'Sale' },
  { id: 13, title: '[ON HAND] G-DRAGON UBERMENSCH OFFICIAL LIGHTSTICK', price: 'From ₱2,600.00', hasOptions: true },
  { id: 14, title: '[ON HAND] BIGBANG - OFFICIAL LIGHTSTICK ver.4', price: '₱3,599.00', originalPrice: '₱4,200.00', hasOptions: false, badge: 'Sale' },
  { id: 15, title: '[ON HAND] AHOF - OFFICIAL LIGHTSTICK [NO POB]', price: 'From ₱3,500.00', hasOptions: true },
  { id: 16, title: '[ON HAND] 2NE1 OFFICIAL LIGHTSTICK', price: '₱3,500.00', hasOptions: true },
]
        ...
        <div style={{ marginBottom: '10px' }}>
          ...
          <span
            style={{
              fontSize: '13px',
              fontWeight: 600,
              color: product.badge === 'Sale' ? PINK : '#121212',
            }}
          >
            {product.price}
          </span>
...
export default function ShopPage() {
  ...
  return (
    <div
      className="shop-mode"
      style={{ background: '#fff', color: '#121212', minHeight: '100vh', fontFamily: FONT }}
    >
      {/* ── ANNOUNCEMENT BAR ── */}
      <div
        role="region"
              ...
              {NAV_LINKS.map(link => (
                <li key={link.label}>
                  <a
                    ...
                    onMouseEnter={e => ((e.target as HTMLAnchorElement).style.color = PINK)}
                    onMouseLeave={e => ((e.target as HTMLAnchorElement).style.color = '#121212')}
                  >
                    {link.label}
                  </a>
                </li>
      ...
      <main>
        ...
        {/* PRE-ORDER */}
        <section id="preorder" style={{ padding: '40px 0', scrollMarginTop: '57px' }}>
        ...
        {/* ON HAND */}
        <section id="onhand" style={{ padding: '40px 0', borderTop: '1px solid #f0f0f0', scrollMarginTop: '57px' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
            <h2 style={{ fontWeight: 700, fontSize: '28px', marginBottom: '24px', color: '#121212', letterSpacing: '0.02em' }}>
              ON HAND
            </h2>
        ...
        <section style={{ background: PINK, padding: '60px 20px', textAlign: 'center' }}>
          <h2 style={{ fontWeight: 700, fontSize: '30px', color: '#fff', marginBottom: '8px' }}>
      ...
      <footer style={{ background: '#fff', borderTop: '1px solid #e5e5e5', padding: '40px 20px' }}>
        <div className="shop-footer-grid" style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          {/* Brand */}
          <div>
            <div style={{ fontWeight: 700, fontSize: '18px', color: PINK, marginBottom: '12px', letterSpacing: '0.02em' }}>
              ARKIVE MARKET
            </div>
          ...
          {/* Pages */}
          <div>
            <h3 style={{ fontWeight: 700, fontSize: '13px', marginBottom: '12px', color: '#121212', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
              Pages
            </h3>
          ...
          <div>
            ...
            <h3 style={{ fontWeight: 700, fontSize: '13px', margin: '16px 0 12px', color: '#121212', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
              Delivered By
            </h3>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
              {['J&T Express', 'LBC', 'GoGo Express'].map(m => (
                <span
                  key={m}
                  style={{
                    fontSize: '12px',
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
            ...
            <button
              ...
              aria-label="Close"
              style={{ marginLeft: 'auto', background: 'none', border: 'none', fontSize: '18px', color: '#888', lineHeight: 1 }}
            >
              ×
            </button>
          </div>
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            <button
              onClick={() => { setCartOpen(true); setNotification(null) }}
              style={{
                flex: 1,
                padding: '8px',
      ...
      {searchOpen && (
        ...
        >
          <div
            style={{ marginTop: 0, background: '#fff', padding: '20px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)' }}
          ...
          >
            ...
            >
              ...
              <button
                type="submit"
                style={{ padding: '12px 20px', background: PINK, color: '#fff', border: 'none', fontSize: '14px', fontWeight: 500 }}
              >
                Search
              </button>
              <button
                ...
                style={{ padding: '12px 14px', background: 'none', border: '1px solid #e5e5e5', fontSize: '18px', color: '#121212' }}
              >
                ×
              </button>
            </form>
      ...
      {menuOpen && (
        ...
        >
          <div
            style={{ width: '280px', background: '#fff', position: 'absolute', left: 0, top: 0, bottom: 0, overflowY: 'auto', boxShadow: '4px 0 20px rgba(0,0,0,0.12)' }}
          >
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 20px', borderBottom: '1px solid #e5e5e5' }}>
              ...
              <button
                ...
                style={{ background: 'none', border: 'none', fontSize: '22px', color: '#121212', lineHeight: 1 }}
              >
                ×
              </button>
            </div>
          ...
          <div
            style={{ flex: 1, background: 'rgba(0,0,0,0.5)', marginLeft: '280px' }}
            onClick={() => setMenuOpen(false)}
          />
        </div>
      )}
              ...
              {cartItems.length === 0 ? (
                ...
                <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  {cartItems.map((item, i) => (
                    <li
                      key={item.cartId}
                      style={{ display: 'flex', gap: '12px', paddingBottom: '12px', borderBottom: '1px solid #f5f5f5', alignItems: 'flex-start' }}
                    >
                      ...
                      <button
                        ...
                        onMouseEnter={e => ((e.currentTarget as HTMLButtonElement).style.color = '#1520A6')}
      ...
      {/* Keyframe for notification slide-in */}
      <style>{`
